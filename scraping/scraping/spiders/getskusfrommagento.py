...
if __name__ == '__main__':
    file = open('cettire_skus_new.txt', 'w', encoding='utf-8')
    ...
    TRS = requests.get('https://admin.brandrange.com/index.php/rest/V1/products?searchCriteria[filterGroups][0][filters][0][field]=IRC&searchCriteria[filterGroups][0][filters][0][value]=CETTIRE | DS&searchCriteria[pageSize]=1&store_id=1,store_code=en', headers=headersMagento)
    ...
    i = 1
    while i < TotalPages:
        resp = requests.get(f'https://admin.brandrange.com/index.php/rest/V1/products?searchCriteria[filterGroups][0][filters][0][field]=IRC&searchCriteria[filterGroups][0][filters][0][value]=CETTIRE | DS&searchCriteria[pageSize]=1000&searchCriteria[currentPage]={i}&store_id=1,store_code=en&fields=items[sku]', headers=headersMagento)
