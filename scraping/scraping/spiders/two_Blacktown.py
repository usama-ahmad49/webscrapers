...
if __name__ == '__main__':
    processed = []
    url = 'https://www.blacktown.nsw.gov.au/Plan-build/Stage-1-find-out/Developments-online/Development-register'
    driver = webdriver.Chrome()
    driver.get(url)
    driver.find_element_by_css_selector('.styled-button').click()
    driver.switch_to.window(window_name=driver.window_handles[-1])
    try:
        WebDriverWait(driver, 25).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="ctl00_Content_btnSearch"]')))
